...
<head>
  ...
  <style>
    ...
    .post-breadcrumb a:hover { color: #d4900a; }
    .post-breadcrumb .sep { opacity: 0.4; }
    .post-header-wrap { max-width: 780px; margin: 20px auto 0; padding: 0 18px; }
    .post-header {
      position: relative; border-radius: 16px;
      border: 1px solid rgba(124,58,237,0.25);
      background: linear-gradient(135deg, rgba(124,58,237,0.10) 0%, rgba(212,144,10,0.06) 60%, transparent 100%);
    ...
    .post-cat {
      ...
      text-transform: uppercase; color: #a78bfa; display: inline-block; margin-bottom: 14px;
    }
    .post-header h1 {
    ...
    .post-prose h2 {
      ...
      border-left: 3px solid #d4900a; padding-left: 14px;
    }
    .post-prose h3 {
    ...
    .post-prose blockquote {
      border-left: 3px solid #d4900a; margin: 24px 0;
    ...
    .post-prose code {
      ...
      background: rgba(0,0,0,0.35); padding: 2px 7px; border-radius: 5px; color: #e8a356;
    }
    .post-prose pre {
    ...
    .post-prose .cta {
      border: 1px solid rgba(212,144,10,0.35); border-radius: 14px;
      background: rgba(212,144,10,0.06); padding: 22px 26px; margin: 32px 0;
    }
    ...
    .post-tag:hover { color: #a78bfa; border-color: rgba(167,139,250,0.45); }
    .post-cta-panel {
      margin-top: 44px; padding: 28px 30px;
      border: 1px solid rgba(124,58,237,0.30); border-radius: 16px;
      background: linear-gradient(135deg, rgba(124,58,237,0.08) 0%, rgba(0,0,0,0.20) 100%);
      text-align: center;
    }
    ...
    .post-cta-btn {
      ...
      border: 1px solid rgba(212,144,10,0.6); background: rgba(212,144,10,0.14);
      color: #f0b429; font-family: var(--shell-mono); font-size: 12px;
      letter-spacing: 0.08em; text-transform: uppercase; text-decoration: none;
      transition: background 0.15s, border-color 0.15s;
    }
    .post-cta-btn:hover { background: rgba(212,144,10,0.24); border-color: rgba(212,144,10,0.8); }
    .post-back {
      ...
      color: #d4900a; text-decoration: none; transition: color 0.15s;
    }
    .post-back:hover { color: #f0b429; }
  </style>
</head>
<body>
  <div id="site-nav"></div>
